                        ...
                        setTip(
                            <Box className='text-red-500'>
                                <Trans i18nKey="This license key has reached the activation limit, <a>click here</a> to manage license and devices to deactivate old devices."
                                    components={{ a: <a href={`https://my6.top/redirect_app/manage_license/${language}`} target='_blank' rel='noreferrer' /> }}
                                />
                            </Box>
                        )
                        break;
    ...
    return (
        <Box sx={{ marginTop: '10px' }}>
            <Button
                ...
                sx={{ marginRight: '10px' }}
                onClick={() => {
                    platform.openLink(`https://my6.top/redirect_app/manage_license/${language}`)
            ...
            <Button
                ...
                sx={{ marginRight: '10px' }}
                onClick={() => {
                    platform.openLink('https://my6.top/redirect_app/view_more_plans')
    ...
    return (
        <Box sx={{ marginTop: '10px' }}>
            <Button
                ...
                sx={{ marginRight: '10px' }}
                onClick={() => {
                    platform.openLink('https://my6.top/redirect_app/get_license')

        ...
        <Dialog open={props.open} onClose={props.close} fullWidth>
            ...
            <DialogContent>
                <Box sx={{ textAlign: 'center', padding: '0 20px' }}>
                    ...
                    <h3 style={{ margin: '4px 0 5px 0' }}>ChatTop
                        {
                ...
                >
                    ...
                    >
                        <Button
                            variant="outlined"
                            onClick={() => platform.openLink(`https://my6.top/redirect_app/check_update/${language}`)}
                        >
                            {t('Check Update')}
                        </Button>
                    </Badge>
                    <Button
                        variant="outlined"
                        sx={{ margin: '4px' }}
                        onClick={() => platform.openLink(`https://my6.top/redirect_app/homepage/${language}`)}
                    >
                        {t('Homepage')}
                    </Button>
                    <Button
                        variant="outlined"
                        sx={{ margin: '4px' }}
                        onClick={() => platform.openLink(`https://my6.top/redirect_app/feedback/${language}`)}
                    >
                        {t('Feedback')}
                    </Button>
                    <Button
                        variant="outlined"
                        sx={{ margin: '4px' }}
                        onClick={() => platform.openLink(`https://my6.top/redirect_app/faqs/${language}`)}
                    >
                        {t('FAQs')}
                    </Button>
                </Box>
                ...
                >
                    ...
                    <div className='my-1'>
                        <a
                            ...
                            onClick={() => platform.openLink(`https://my6.top/redirect_app/donate/${language}`)}
                        >
                            {t('Donate')}
                        </a>
                        <a
                            className='underline font-normal cursor-pointer mr-4' style={{ color: theme.palette.primary.main }}
                            onClick={() => platform.openLink(`https://my6.top/redirect_app/author/${language}`)}
                        >
                        ...
                        {/* <Button
                            variant="text"
                            onClick={() =>
                                api.openLink(`https://my6.top/redirect_app/become_sponsor/${language}`)
                            }
                        >

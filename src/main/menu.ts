            ...
            submenu: [
                {
                    label: 'Learn More',
                    click() {
                        shell.openExternal('https://my6.top')
                    },
                },
                {
                    label: 'Github Repo',
                    click() {
                        shell.openExternal('https://github.com/sej95/chatbox')
                    },
                },
                // {
                ...
                // },
                {
                    label: 'Search Issues',
                    click() {
                        shell.openExternal('https://github.com/sej95/chatbox/issues?q=is%3Aissue')
                    },
                },
            ],
        }
